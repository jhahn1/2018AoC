...
const reposeRecord = require('./repose-record.js');
const reposeRecord2 = require('./repose-record2.js');

describe('Day 4: Repose Record', () => {
    it('should properly calculate guard id multiplied by sleep minute', () => {
        const log =
        ...
        assert.equal(reposeRecord(log), 240);
    });

    it('should properly calculate guard id multiplied by sleep minute Part 2', () => {
        const log =
        `[1518-11-01 00:00] Guard #10 begins shift
        [1518-11-01 00:05] falls asleep
        [1518-11-01 23:58] Guard #99 begins shift
        ...
        assert.equal(reposeRecord2(log), 4455);
    });
    ...
    it('should properly calculate guard id multiplied by sleep minute', () => {
        ...
        assert.equal(reposeRecord2(log), 240);
    });
});